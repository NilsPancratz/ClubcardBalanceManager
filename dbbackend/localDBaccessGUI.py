...
class LocalBalanceManager:
	...
	def __init__(self, master):
		...
		self.clubcardInputField = tk.Text(self.topframe, wrap='none', font=("Arial", 27))
		self.clubcardInputField.place(x=10, y=10, width=290, height = 50)
		
		self.clubcardInputFieldReset = tk.Button(self.topframe, anchor='c', text='\u2327', bg='#ff9d00', fg='black', font=("Arial", 20), command=lambda: self.clubcardfieldreset())
		...
		self.descriptionLabel = tk.Label(self.topframe, anchor='sw', text="Guthaben:", bg='#ff9d00', fg='black', font=("Arial", 14))
		...
		self.button_aufladen = tk.Button(self.topframe, anchor='w', text='aufladen (+)', bg='#ff9d00', fg='#3d9a40', font=("Arial", 20), command=lambda: aufladen(self.currentUID, float(amount_string)))
		self.button_aufladen.place(x=10, y=150, width=150)

		self.button_belasten = tk.Button(self.topframe, anchor='e', text='belasten (-)', bg='#ff9d00', fg='#b43300', font=("Arial", 20), command=lambda: belasten(self.currentUID, -float(amount_string)))
		self.button_belasten.place(x=190,y=150, width=150)
		...
		self.cleartransactionbutton = tk.Button(self.centerframe, anchor='c', text="\u2327", bg='black', fg='white', font=("Arial", 20), command=lambda: self.numpad_click_ac())
		self.cleartransactionbutton.place(x=0, y=0, relwidth=1/3, height=100)




		self.button_9 = tk.Button(self.bottomframe, anchor='c', text="9", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: numpad_click_number(9))
		self.button_9.place(x=2*350/3, y=0*400/4, relwidth=1/3, relheight=1/4)

		self.button_8 = tk.Button(self.bottomframe, anchor='c', text="8", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: numpad_click_number(8))
		self.button_8.place(x=1*350/3, y=0*400/4, relwidth=1/3, relheight=1/4)

		self.button_7 = tk.Button(self.bottomframe, anchor='c', text="7", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: numpad_click_number(7))
		self.button_7.place(x=0*350/3, y=0*400/4, relwidth=1/3, relheight=1/4)

		self.button_6 = tk.Button(self.bottomframe, anchor='c', text="6", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: numpad_click_number(6))
		self.button_6.place(x=2*350/3, y=1*400/4, relwidth=1/3, relheight=1/4)

		self.button_5 = tk.Button(self.bottomframe, anchor='c', text="5", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: numpad_click_number(5))
		self.button_5.place(x=1*350/3, y=1*400/4, relwidth=1/3, relheight=1/4)

		self.button_4 = tk.Button(self.bottomframe, anchor='c', text="4", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: numpad_click_number(4))
		self.button_4.place(x=0*350/3, y=1*400/4, relwidth=1/3, relheight=1/4)

		self.button_3 = tk.Button(self.bottomframe, anchor='c', text="3", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: numpad_click_number(3))
		self.button_3.place(x=2*350/3, y=2*400/4, relwidth=1/3, relheight=1/4)

		self.button_2 = tk.Button(self.bottomframe, anchor='c', text="2", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: numpad_click_number(2))
		self.button_2.place(x=1*350/3, y=2*400/4, relwidth=1/3, relheight=1/4)

		self.button_1 = tk.Button(self.bottomframe, anchor='c', text="1", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: numpad_click_number(1))
		self.button_1.place(x=0*350/3, y=2*400/4, relwidth=1/3, relheight=1/4)

		self.button_delete = tk.Button(self.bottomframe, anchor='c', text="\u232b", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: self.numpad_click_delete())
		self.button_delete.place(x=2*350/3, y=3*400/4, relwidth=1/3, relheight=1/4)

		self.button_dot = tk.Button(self.bottomframe, anchor='c', text=".", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: self.numpad_click_comma())
		self.button_dot.place(x=1*350/3, y=3*400/4, relwidth=1/3, relheight=1/4)

		self.button_0 = tk.Button(self.bottomframe, anchor='c', text="0", bg = '#555555', fg='white', font=("Arial", 30), command=lambda: numpad_click_number(0))
	...
	def check_key(self, event):
		if event.keysym == "Return":
			...
			if ":" not in text: #wenn kein : im String ist Wahrscheinlichkeit groß, dass Eingabe ueber RFID Reader erfolgt ist
